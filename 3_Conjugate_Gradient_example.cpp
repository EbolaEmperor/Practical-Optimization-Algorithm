...
int main(){
    ...
    rosenbrock::n = n;
    ColVector x2 = CG_FR(rosenbrock::f, rosenbrock::grad, rosenbrock::initial(), 1e-6, 0.1, 0.4);
    cout << "min f = f(" << x2.T() << ") = " << rosenbrock::f(x2) << endl << endl;

    cout << "Restart FR-CG Method (gradfree) solve n-dim rosenbrock minimal" << endl;
    rosenbrock::n = n;
    ColVector x3 = CG_FR_gradfree(rosenbrock::f, rosenbrock::initial(), 1e-6, 0.1, 0.4);
